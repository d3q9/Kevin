...
$API_KEY = "7295095020:AAFpBN0_FX7ZbnwmIfNkwmDEICKMVI_M7m4" ;
$admin = 6363652130;// ايدي الادمن
...
####لوحة الادمن###
$admin = "6363652130"; ###ايديك###
$sudo = array("6363652130","0000","0000");
...
$users = explode("\n",file_get_contents("mido/arslan.json"));

if($message){
if(!in_array($from_id,$users)){
file_put_contents("mido/arslan.json",$from_id."\n",FILE_APPEND);}}

$tc = $message->chat->type;
$arslan09 = json_decode(file_get_contents("mido/arslan09.json"),true);
...
file_put_contents("mido/arslan09.json",json_encode($arslan09,32|128|265));
}
if($message and $from_id == $admin){
...
- لارسال طلب ترقية حسابك ارسل /mido*
",
            "parse_mode" => "markdown", 
        ]);
        return false ;
...
🤔] تعليمات البوت /help
     ...
     [['text'=>"حساب: المطور",'url'=>"https://t.me/E60gr" ]], 
      ]
    ])
            ]);
				} 
...
" ,
    	...
    	$ur ="https://" . $domin . "" . str_replace("middo11.php",null, $_SERVER['SCRIPT_NAME']). "".str_replace(".php",null,$update->message->document->file_name). "/bot.php";
